...
**Response**: The boxplots are now filled in with different colors
...
**Response**:The boxplot lets you easily determine things like IQR and
outliers. The jitterplot is better at showing individual values of data.
...
**Response**:I think the .md is better because it shows all graphics and
no code is showing.
...
**Response**: I think the jitter over the boxplot is better because when
the boxplot is on top it covers the point of data.
...
**Response**: I noticed that this took me way too long to figure out.
Anyway, Putting the aesthetic in specific geoms can change what is being
colored etc.
