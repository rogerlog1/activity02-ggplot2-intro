...
**Response**:The boxplot lets you easily determine things like IQR and outliers. The jitterplot is better at showing individual values of data.
...
**Response**:I think the .md is better because it shows all graphics and no code is showing.
...
**Response**: I think the jitter over the boxplot is better because when the boxplot is on top it covers the point of data.
...
**Response**: I noticed that this took me way too long to figure out. Anyway, Putting the aesthetic in specific geoms can change what is being colored etc.
...
**Response**:It would appear that species is creating these points more than the other two, as the data for species is concentrated around 39 for Adelie and 46 for the other two.
